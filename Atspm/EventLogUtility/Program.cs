...
if (OperatingSystem.IsWindows())
{
    ...
    {
        // Event Log source creation requires admin privileges - skip if not available
        Console.WriteLine("Warning: Unable to create Event Log source (requires administrator privileges). Event logging to Windows Event Log will be disabled.");
    }
}
