    ...
    public partial class SeedProductsDeviceConfigsAndDetectionTypes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "TEXT",
                nullable: false,
                defaultValue: new DateTime(2026, 1, 29, 20, 31, 33, 971, DateTimeKind.Local).AddTicks(5237),
                oldClrType: typeof(DateTime),
                oldType: "TEXT",
                oldDefaultValue: new DateTime(2026, 1, 29, 20, 2, 20, 478, DateTimeKind.Local).AddTicks(8466));
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "TEXT",
                nullable: false,
                defaultValue: new DateTime(2026, 1, 29, 20, 2, 20, 478, DateTimeKind.Local).AddTicks(8466),
                oldClrType: typeof(DateTime),
                oldType: "TEXT",
                oldDefaultValue: new DateTime(2026, 1, 29, 20, 31, 33, 971, DateTimeKind.Local).AddTicks(5237));

            // Remove DetectionTypeMeasureType join table entries
